...
export const product1 = new Product(1, "Azure DB", ITEMS.azureServer, 2999, [1, 1])
export const product2 = new Product(2, "Firebase", ITEMS.firebaseServer, 599, [1, 1])
...
export const product10 = new Product(10, "Board Room", ITEMS.bordRoomImage, 25000, [3, 2])